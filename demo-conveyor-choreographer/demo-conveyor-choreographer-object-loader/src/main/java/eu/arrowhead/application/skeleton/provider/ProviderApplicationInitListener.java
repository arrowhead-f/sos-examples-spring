...
import ai.aitia.demo.object.loader.Constant;
...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		arrowheadService.forceRegisterServiceToServiceRegistry(createServiceRegistryRequest(LoadObjectService.SERVICE_DEFINITION,
																							LoadObjectService.PATH,
																							LoadObjectService.METHOD));
	}
