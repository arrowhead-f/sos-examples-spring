...
START "demo-energy-forecast-indoor-provider" /B "cmd /c START java -jar demo-energy-forecast-indoor-provider-4.1.3.jar 2>&1"
echo indoor-provider started

cd ..\..\demo-energy-forecast-outdoor-provider\target
START "demo-energy-forecast-outdoor-provider" /B "cmd /c START java -jar demo-energy-forecast-outdoor-provider-4.1.3.jar 2>&1"
echo outdoor-provider started

cd ..\..\demo-energy-forecast-provider\target
START "demo-energy-forecast-provider" /B "cmd /c START java -jar demo-energy-forecast-provider-4.1.3.jar 2>&1"
